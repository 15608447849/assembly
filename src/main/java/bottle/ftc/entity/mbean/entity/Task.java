...
import bottle.ftc.entity.mbean.singer.StateNotification;
...
public class Task {
    ...
    //进度状态
    private bottle.ftc.entity.mbean.entity.State stateing;
    //下载的文件MD5
     ...
     * @return
     */
    public bottle.ftc.entity.mbean.entity.State getExistState(){
        return stateing;
    }
    //获取状态值
    public bottle.ftc.entity.mbean.entity.State getProgressState(){
        if (stateing == null) stateing = new bottle.ftc.entity.mbean.entity.State(this);
        return stateing;
    }
    //获取状态值
    public bottle.ftc.entity.mbean.entity.State getProgressStateAndAddNotify(){
        if (stateing == null) stateing = new bottle.ftc.entity.mbean.entity.State(this);
...
//            if (t.getTid() == getTid()) return true;
    ...
    public interface onResult{
        void onSuccess(bottle.ftc.entity.mbean.entity.State state);
        void onFail(bottle.ftc.entity.mbean.entity.State state);
        void onLoading(bottle.ftc.entity.mbean.entity.State state);
    }
    public static abstract class onResultAdapter implements onResult{
        public void onSuccess(bottle.ftc.entity.mbean.entity.State state){}
        public void onFail(bottle.ftc.entity.mbean.entity.State state){}
        public void onLoading(bottle.ftc.entity.mbean.entity.State state){}
    }
